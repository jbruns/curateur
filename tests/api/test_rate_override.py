...
def test_rate_override_applies_api_limits_when_disabled():
    ...
    limits = override.get_effective_limits(
        {"maxthreads": 3, "maxrequestspermin": 90, "maxrequestsperday": 5000}
    )
...
def test_rate_override_caps_user_values_and_warns():
    ...
    override = RateLimitOverride(config)
    limits = override.get_effective_limits(
        {"maxthreads": 4, "maxrequestspermin": 120, "maxrequestsperday": 20000}
    )
