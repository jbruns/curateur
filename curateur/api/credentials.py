...
# PLACEHOLDER: Run setup_dev_credentials.py to generate actual values
_DEV_ID_OBFUSCATED = bytearray([
    # Test credentials - replace with actual values for production
    23, 16, 1, 21, 43, 1, 16, 4, 0, 26, 7
])

_DEV_PASSWORD_OBFUSCATED = bytearray([
    # Test credentials - replace with actual values for production
    23, 16, 1, 21, 43, 1, 16, 4, 0, 3, 2, 1, 22, 18, 1, 1, 7
])
